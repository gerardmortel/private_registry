...
# REGISTRY_AUTH_FILE="$HOME/.docker/config.json" # Use this for docker
REGISTRY_AUTH_FILE="${XDG_RUNTIME_DIR}/containers/auth.json" # Use this for podman. DO NOT EXPORT
export ICR_USERNAME=""
